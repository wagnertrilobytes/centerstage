...
//
//@Autonomous(name = "Autonomous Camera Test")
//@Disabled
...
//        camera = OpenCvCameraFactory.getInstance().createWebcam(robot.camera, cameraMonitorViewId);
...
//    }
//
//    void tagMove(AprilTagDetection tagOfInterest) {
