...
public class ColourMassDetectionProcessorTwo implements VisionProcessor {
	...
	public ColourMassDetectionProcessorTwo(Scalar lower, Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
