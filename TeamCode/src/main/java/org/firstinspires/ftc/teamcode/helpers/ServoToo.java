...
public class ServoToo {
    ...
    public ServoToo(Servo servo, double minAngle, double maxAngle, AngleUnit angleUnit) {
        this.servo = servo;
    ...
    public ServoToo(HardwareMap hw, String servoName, double minAngle, double maxAngle, AngleUnit angleUnit) {
    ...
    public ServoToo(HardwareMap hw, String servoName, double minDegree, double maxDegree) {
    ...
    public String getDeviceType() {
        ...
        return "ServoToo: " + port + "; " + controller;
    }
